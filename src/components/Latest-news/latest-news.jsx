        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="item md-mb50 wow fadeInUp" data-wow-delay=".3s">
              <div className="img">
                <img src="/img/img-music/img-10-udg.jpeg" alt="" />
              </div>
              <div className="cont">
                <div>
                  <div className="info">
                  ...
                  <h5>
                    <a>Te contamos todo sobre la armonía musical.</a>
                  </h5>
          ...
          <div className="col-lg-6">
            <div className="item md-mb50 wow fadeInUp" data-wow-delay=".5s">
              <div className="img">
                <img src="/img/img-music/img-09-udg.jpeg" alt="" />
              </div>
              <div className="cont">
                <div>
                  <div className="info">
                  ...
                  <h5>
                    <a>Crece tu negocio musical aplicando lo siguiente.</a>
                  </h5>
                  <div className="btn-more">
                    <a className="simple-btn main-color">Leer más</a>
                  </div>
