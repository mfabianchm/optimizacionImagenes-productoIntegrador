                ...
                <div className="item">
                  ...
                  <div className="valign">
                    <p className="fz-20 fw-200">
                      Este es el mejor sitio para aprender música, sin duda lo
                      recomiendo.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="info inf-lrg valign">
                    <div className="cont">
                      <div className="author">
                        ...
                        <h6 className="author-name color-font">Karla García</h6>
                      </div>
                    </div>
                  </div>
                  <div className="valign">
                    <p className="fz-20 fw-200">
                      A mi familia le encanta cuando toco el piano y todo
                      gracias a esta escuela.
                    </p>
                  </div>
                </div>
                <div className="item">
                  ...
                  <div className="valign">
                    <p className="fz-20 fw-200">
                      Me dieron todo lo necesario para comenzar a interpretar
                      mis canciones favoritas en la guitarra.
                    </p>
                  </div>
                </div>
                <div className="item">
                  ...
                  <div className="valign">
                    <p className="fz-20 fw-200">
                      Realmente tienes los mejores precios del mercado, no los
